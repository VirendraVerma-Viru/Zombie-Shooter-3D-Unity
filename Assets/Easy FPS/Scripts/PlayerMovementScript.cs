...
public class PlayerMovementScript : MonoBehaviour {
	...
	*/
	void PlayerMovementLogic(){
		...
		if (grounded) {
           // rb.AddRelativeForce(joystick.Horizontal * accelerationSpeed * Time.deltaTime, 0, joystick.Vertical * accelerationSpeed * Time.deltaTime);
            ...
            //rb.AddRelativeForce(joystick.Horizontal * accelerationSpeed / 2 * Time.deltaTime, 0, joystick.Vertical * accelerationSpeed / 2 * Time.deltaTime);
